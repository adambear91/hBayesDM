#' @templateVar MODEL_FUNCTION choiceRT_ddm_conditional
...
#' @templateVar DATA_COLUMNS "subjID", "choice", "RT", "condition"
...
choiceRT_ddm_conditional <- hBayesDM_model(
  task_name       = "choiceRT",
  model_name      = "ddm",
  model_type      = "",
  data_columns    = c("subjID", "choice", "RT", "condition"),
  parameters      = list(
    "alpha" = c(0, 0.5, Inf),
    "beta" = c(0, 0.5, 1),
    "delta" = c(-Inf, 0, Inf),
